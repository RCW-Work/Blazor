...
namespace BlazorSCADA.ModbusTCP
{
    ...
    public class ModbusServerService
    {
        ...
        private static bool _no_sync_connection = true;
        ...
        // ------------------------------------------------------------------------
        /// <summary>Create ModbusServerService instance without parameters.</summary>
        ...
        public ModbusServerService(string ip, ushort port)
        {
        ...
        public ModbusServerService(string ip, ushort port, bool no_sync_connection)
        {
